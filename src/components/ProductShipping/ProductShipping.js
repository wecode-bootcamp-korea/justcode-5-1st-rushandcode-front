...
function ProductShipping() {
  return (
    <div className={css.container}>
      <ProductTab />
      <div>
        <div className={css.ship_desc}>
          배송비: 기본배송료는 2500원 입니다. (도서,산간,오지 일부지역은
          배송비가 추가될 수 있습니다.)
        </div>
        <div className={css.ship_desc}>택배사: 우체국 택배를 이용합니다.</div>
        <div className={css.ship_desc}>
          배송가능지역: 국내 배송 / 해외 배송은 불가 합니다.
        </div>
      </div>
      <div className={css.exchange_container}>
        <div className={css.exchange_desc}>홈페이지에서 구매한 경우</div>
        <div className={css.exchange_desc}>
