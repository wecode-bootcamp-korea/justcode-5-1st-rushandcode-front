        ...
        <ul>
          <li className={css.event}>
            ...
            <div className={css.event_text}>
              ...
              <p className={css.text_3}>2022.06.25 00:00 - 2022.06.30.23:59</p>
            </div>
          </li>
          <li className={css.event}>
            <img
            ...
            <div className={css.event_text}>
              ...
              <p className={css.text_3}>2022.06.08 00:00 - 2022.07.03.23:59</p>
            </div>
          </li>
          <li className={css.event}>
            <img
            ...
            <div className={css.event_text}>
              ...
              <p className={css.text_3}>2022.06.03 00:00 - 2022.06.30.23:59</p>
            </div>
          </li>
          <li className={css.event}>
            <img
            ...
            <div className={css.event_text}>
              ...
              <p className={css.text_3}>2022.06.02 00:00 - 2022.06.30.23:59</p>
            </div>
          </li>
        </ul>
      </div>
